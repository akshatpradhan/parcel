  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved garden as @garden" do
        ...
        post :create, {:garden => { "title" => "invalid value" }}, valid_session
        assigns(:garden).should be_a_new(Garden)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested garden" do
        ...
        Garden.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => garden.to_param, :garden => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the garden as @garden" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Garden.any_instance.stub(:save).and_return(false)
        put :update, {:id => garden.to_param, :garden => { "title" => "invalid value" }}, valid_session
        assigns(:garden).should eq(garden)
      end
